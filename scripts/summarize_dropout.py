...
sweep_folders = [f for f in os.listdir(results_dir) if f.startswith("sweep_dropout_")]
...
# 💾 Save summary
summary_path = os.path.join(results_dir, "dropout_summary.json")
...
plot_path = os.path.join(results_dir, "dropout_summary_plot.png")
